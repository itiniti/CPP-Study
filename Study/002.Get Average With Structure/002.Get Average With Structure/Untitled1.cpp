...
int main(void) {
	...
	cout << "------------------------------------------------------------"<<endl;
	cout << "최저 점수 : " << GetMinScore(Students, nStudentsCount) << endl << "최대 점수 : " << GetMaxScore(Students, nStudentsCount) << endl << "평균 점수 : " << GetAverage(Students, nStudentsCount) << endl<<// " 총 학생 수 : " << sizeof(student)/sizeof(int)//;
	//sizeof 를 이용해보려 했지만 잘안됌  
}
